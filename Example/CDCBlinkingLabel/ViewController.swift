...
//  CDCBlinkingLabel
//
//  Created by Chengappa C D on 07/29/2016.
//  Copyright (c) 2016 Chengappa C D. All rights reserved.
//

import UIKit
import CDCBlinkingLabel

class ViewController: UIViewController {

    var isBlinking = false
    let blinkingLabel = CDCBlinkingLabel(frame: CGRectMake(10, 20, 200, 30))
